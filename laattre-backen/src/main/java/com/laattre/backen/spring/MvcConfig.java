...
import com.laattre.backen.validation.EmailValidator;
import com.laattre.backen.validation.PasswordMatchesValidator;

@Configuration
@ComponentScan(basePackages = { "com.laattre.backen.web" })
@EnableWebMvc
